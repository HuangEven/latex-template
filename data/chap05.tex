...
图~\ref{fig:scale-vs-exp} 展示了规模层级与实验类型的映射，表~\ref{tab:data-split} 则进一步说明了不同实验口径下的数据使用方式。
...
图~\ref{fig:metric-taxonomy} 给出了指标体系结构，表~\ref{tab:fairness-controls} 则明确了比较原则与控制变量。
