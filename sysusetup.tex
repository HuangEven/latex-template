...
\sysusetup{
  ...
  %
  % 指导教师
  %   - 封面使用 supervisor / supervisor-title（可显示姓名+职称）
  %   - 扉页若只显示导师姓名：用 titlepage-supervisor，保持 titlepage-supervisor-title 为空
  supervisor  = {黄聃},
  supervisor-title  = {教授},
  titlepage-supervisor = {黄聃},
  titlepage-supervisor-title = {},
  % jointsupervisor = {},
  % jointsupervisor-title  = {},
  %
  % 答辩委员会成员
  committee-chair = {},
  committee-member1 = {},
